...
define config.name = _("The Big Dog That Grants Wishes")
...
define build.name = "TheBigDogThatGrantsWishes"
...
define config.save_directory = "TheBigDogThatGrantsWishes-1766140788"
